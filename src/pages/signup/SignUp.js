      ...
      <div className={style.checkbtnbox}>
        ...
        <div className={style.checkbtn}>
          ...
          <span className={isOpen2 ? style.showmenu : style.hidemenu}>
            ...
            <br />
            3. 스테이폴리오는 개인정보처리방침을 정하고 이를 귀하께서 언제나
            ...
            자유롭게 접근할 수 있습니다. 스테이폴리오에서 예약 및 프로모션.
            ...
            4. 개인정보 수집에 대한 동의
            <br />
            - 스테이폴리오는 귀하께서 스테이폴리오의 개인정보처리방침 및
            ...
            6. 비회원의 개인정보보호
            <br />
            - 스테이폴리오는 비회원 주문의 경우에도 예약정보, 대금결제, 예약내역
            조회 및 예약확인, 실명여부 확인을 위하여 필요한 개인정보만을
            요청하고 있으며, 이 경우 그 정보는 대금결제 및 객실예약 관련된 용도
            이외에는 다른 어떠한 용도로도 사용되지 않습니다.
            <br />
            ...
            <br />- 스테이폴리오는 회원에 대하여 보다 더 질 높은 서비스 제공
            ...
            요구하는 경우 스테이폴리오는 지체없이 그 열람, 확인 할 수 있도록
            조치합니다.
            <br />
            <br />제 7조 (개인정보의 파기 절차)
            <br />
            스테이폴리오는 원칙적으로 개인정보 수집 및 이용목적이 달성된 후에는
            ...
            -기술적 대책
            <br />
            스테이폴리오는 귀하의 개인정보를 처리함에 있어 개인정보가 분실,
            ...
            통제하고 있습니다.
            <br />
            - 스테이폴리오는 이용자 개인의 실수나 기본적인 인터넷의 위험성
            ...
            상실, 유출, 변조, 훼손이 유발될 경우 스테이폴리오는 즉각 귀하께
            사실을 알리고 적절한 대책과 보상을 강구할 것입니다.
            <br />
            <br />제 9조 (링크사이트)
            <br />
            스테이폴리오는 귀하께 다른 회사의 웹사이트 또는 자료에 대한 링크를
            제공할 수 있습니다. 이 경우 스테이폴리오 외부사이트 및 자료에 대한
            아무런 통제권이 없으므로 그로부터 제공받는 서비스나 자료의 유용성에
            대해 책임질 수 없으며 보증할 수 없습니다. 스테이폴리오가 포함하고
            있는 링크를 클릭(Click)하여 타 사이트(Site)의 페이지로 옮겨갈 경우
            해당 사이트의 개인정보처리방침은 스테이폴리오와 무관하므로 새로
            방문한 사이트의 정책을 검토해 보시기 바랍니다.
            <br />
            <br />제 10조 (게시물)
            <br />
            1. 스테이폴리오는 귀하의 게시물을 소중하게 생각하여 변조, 훼손,
            ...
            타인의 신상 공개 시 특정부분 이동 경로를 밝혀 오해가 없도록 하고
            있습니다. 그 외의 경우 명시적 또는 개별적인 경고 후 삭제 조치할 수
            있습니다.
            <br />
            ...
            스테이폴리오에 서면, 전화 또는 이메일로 연락하시면 지체 없이
            조치하겠습니다.
            <br />
            ...
            <br />
            3. 스테이폴리오는 귀하의 요청에 의해 해지 또는 삭제된 개인정보는 “제
            6조 개인정보의 보유, 이용기간’에 명시된 바에 따라 처리하고 그 외의
            ...
            1. 쿠키(cookie)란?
            <br />
            스테이폴리오는 귀하에 대한 정보를 저장하고 수시로 찾아내는
            쿠키(cookie)를 사용합니다. 쿠키는 웹사이트가 귀하의 컴퓨터
            브라우저(넷스케이프, 인터넷익스플로러 등)로 전송하는 소량의
            정보입니다. 귀하께서 웹사이트에 접속을 하면 스테이폴리오의 서버는
            귀하의 브라우저에 추가정보를 임시로 저장하여 접속에 따른 성명 등의
            추가 입력 없이 스테이폴리오의 서비스를 제공할 수 있습니다. 쿠키는
            귀하의 컴퓨터는 식별하지만 귀하를 개인적으로 식별하지는 않습니다.
            또한 귀하는 쿠키에 대한 선택권이 있습니다.
            <br />
            2. 스테이폴리오의 쿠키 운용
            <br />
            스테이폴리오는 이용자의 편의를 위하여 쿠키를 운영합니다.
            스테이폴리오가 쿠키를 통해 수집하는 정보는 회원ID에 한하며, 그 외의
            다른 정보는 수집하지 않습니다. 스테이폴리오가 쿠키를 통해 수집한
            회원 ID는 다음의 목적을 위해 사용됩니다.
            <br />
            ...
            있습니다.
            <br />
            - 다만, 쿠키의 저장을 거부할 경우에는 로그인이 필요한 스테이폴리오
            ...
            <br />
            스테이폴리오는 귀하가 좋은 정보를 안전하게 이용할 수 있도록 최선을
